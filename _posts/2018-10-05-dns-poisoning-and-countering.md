...
DNS 污染极为简单易行且效果极佳，一直都是各种神鬼蛇神搞事的极佳手段。这篇东西介绍一下常见的 DNS 投毒现象，以及草民尝试过的几种避免被投毒的方案。
...
使用这样的方法，一般来说在不考虑运营商投毒和 SLA 的情况下都足够解决问题，但是运营商抢答已经是家常便饭了，如果不幸被运营商抢答该如何是好？

## 反制策略 2：使用公共 DNS 的非公开端口
...
# 技巧：如何拦截内网中的所有 DNS 请求，并全部交由路由器进行处理
