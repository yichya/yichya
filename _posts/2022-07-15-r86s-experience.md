...
按照计划最近的应该是 Gadgets，那就从 Gadgets 的坑开始填吧。当然这次只介绍 R86S，其他的（主要投入的精力确实有限，也不那么值得扯很多）除了蓝牙开关和 UPS 会分别在对应的系列详细介绍之外，统一在 [Gadgets (2022)](../gadgets-2022/) 里面介绍。
...
_Update：事实证明 RZ608 还是一样不稳定，两周多时间大概挂了三四次的样子。建议还是搭配 WatchCat 之类的工具使用。_
